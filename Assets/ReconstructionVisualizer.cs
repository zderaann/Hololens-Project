...
//draw the reconstruction mesh
    public bool DrawMesh(byte[] reconstructionFile, RansacItem transform)
    {
        Mesh mesh = new PLYloader().LoadFile(reconstructionFile, false, transform);
