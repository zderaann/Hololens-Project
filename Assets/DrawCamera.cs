...
public class DrawCamera : MonoBehaviour {
    ...
    Vector3[] newVertices = { new Vector3( 0f, 0f, 0f), new Vector3(-0.06f, -0.04f, -0.1f), new Vector3(-0.06f, 0.04f, -0.1f), new Vector3(0.06f, -0.04f, -0.1f), new Vector3(0.06f, 0.04f, -0.1f) };
